---
name: wildone-design
description: Design system skill for wildone. Activate when building UI components, pages, or any visual elements. Provides exact color tokens, typography scale, spacing grid, component patterns, and craft rules. Read references/DESIGN.md before writing any CSS or JSX.
---

# wildone Design System

You are building UI for **wildone**. Light-themed, neutral palette, sans-serif typography (sans-serif), compact density on a 4px grid, flat elevation (no shadows).
...
![wildone Homepage](screenshots/homepage.png)
...
- **Site URL:** `https://www.wildone.com`
...
- Creating new components, pages, or visual elements for wildone
- Writing CSS, Tailwind classes, styled-components, or inline styles
- Building page layouts, templates, or responsive designs
- Reviewing UI code for design consistency
- The user mentions "wildone" design, style, UI, or theme
