...
|---|---|---|---|---|---|
| T-000 | Verification harness | building | 2 | | Gaps only: core-logic tests, 3 flow smoke tests, clip sweep in repo. Nothing else runs until merged. |
...
| T-003 | No sideways scroll or cut-off controls on narrow phones | proposed | 0 | | From T-000 clip evidence; the drill answer row fails even at 16px. |
