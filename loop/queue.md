...
| T-005 | Design foundations: iOS type ramp, system font, tokens, Auto theme, verify-design gate | review | 2 | | from inbox 2026-09-25 (premium iOS redesign; loop/design/brief.md). Scope adds the status-bar overlap fix (owner screenshot 2026-09-26). |
